...
HEADS="${HEADS:-16}"
HISTORY_LAYERS="${HISTORY_LAYERS:-6}"
Q_LAYERS="${Q_LAYERS:-4}"
NUM_QUERIES="${NUM_QUERIES:-48}"
DROPOUT="${DROPOUT:-0.0}"
NUM_WORKERS="${NUM_WORKERS:-0}"
DEVICE="${DEVICE:-cuda}"
CHECKPOINT_DIR="${CHECKPOINT_DIR:-checkpoints/q_probe}"
SNAPSHOT_EVERY_BATCHES="${SNAPSHOT_EVERY_BATCHES:-10000}"
LOG_WINDOW="${LOG_WINDOW:-1000}"
CHECK_POSITIVE_WEIGHT="${CHECK_POSITIVE_WEIGHT:-5.0}"
